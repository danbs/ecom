<script>
    ...
    function addNewProduct(modalId) {
...
<div class="bg-white">
    ...
    <header class="absolute inset-x-0 top-0 z-50">
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <button on:click={() => addNewProduct("modalAddProduct")}
                        class="text-sm font-semibold leading-6 text-gray-900">Add New
                    Product <span
    ...
    <main id="wrapper" class="isolate">
        ...
        <div class="bg-white">
            <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                ...
                <div class="border-b border-gray-200 pb-10 pt-24">
                    ...
                    <p class="mt-4 text-base text-gray-500">Checkout out these products, cool and
                        trendy!</p>
                </div>
                <br>
                <br>
                <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                    {#each data.products as product}
                        <a id="{product.id}" href="#" class="group">
        ...
        <div id="modalAddProduct" class="hidden relative z-10" aria-labelledby="modal-title" role="dialog"
             aria-modal="true">
            <!--
                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    ...
                    <div class=" relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                        <div class="mx-auto max-w-2xl text-center">
                            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">New Product</h2>
                            <p class="mt-2 text-lg leading-8 text-gray-600">Add the required product attributes.</p>
                        </div>
                        <form action="#" method="POST" class="px-6 pb-8 pt-8 sm:pb-32 lg:px-8 lg:py-4">
                            <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                                <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">

                                    <div class="sm:col-span-2">
                                        <label for="name"
                                               class="block text-sm font-semibold leading-6 text-gray-900">Product
                                            Name</label>
                                        <div class="mt-2.5">
                                            <input type="text" id="name"
                                                   class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" bind:value={selectedProduct.name}>
                                        </div>
                                    </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="relative mt-2 rounded-md shadow-sm">
                                                ...
                                                <input type="text" id="price"
                                                       ...
                                                       placeholder="0.00" aria-describedby="price-currency" bind:value={selectedProduct.price}>
                                    ...
                                    <div class="sm:col-span-2">
                                        <label for="imageUrl"
                                               class="block text-sm font-semibold leading-6 text-gray-900">Image
                                            URL</label>
                                        <div class="mt-2.5">
                                            <input type="text"  id="imageUrl" autocomplete="tel"
                                                   class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" bind:value={selectedProduct.imageUrl}>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-8 flex justify-end">
                                    ...
                                    <button type="button" on:click={() => addNewProduct("modalAddProduct")}
                                            class="lg:ml-3 rounded-md bg-indigo-50 px-3.5 py-2.5 text-sm font-semibold text-indigo-600 shadow-sm hover:bg-indigo-100">
                                       Cancel
                                    </button>
